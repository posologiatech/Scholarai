...
export const EXAMPLE_QUERIES = {
  pt: [
    ...
    "Compare mortalidade entre Ceará e Maranhão nos últimos 10 anos",
    "População estimada por UF no Brasil de 2018 a 2024",
    "Relação entre PIB per capita e casos de dengue por UF",
    "Ranking de tuberculose por UF no Nordeste 2015-2023",
    "Correlação entre mortalidade e PIB no Sudeste 2015-2022",
  ],
  en: [
    ...
    "Compare mortality between Ceará and Maranhão over the last 10 years",
    "Estimated population by state in Brazil from 2018 to 2024",
    "Relationship between GDP per capita and dengue cases by state",
    "Tuberculosis ranking by state in Northeast Brazil 2015-2023",
    "Correlation between mortality and GDP in Southeast 2015-2022",
  ],
};
