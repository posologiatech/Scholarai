        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/discover/history" element={<ProtectedRoute><DiscoverHistory /></ProtectedRoute>} />
              ...
              <Route path="/surveys/:id/distribute/:subtab" element={<ProtectedRoute><SurveyBuilder /></ProtectedRoute>} />
