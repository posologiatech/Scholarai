...
const FEATURES_MANIFEST: Omit<ChangelogEntry, "id" | "created_at">[] = [
  ...
  { title: "Projetos de Pesquisa (modo orientador/PI)", description: "Workspace completo por projeto de pesquisa (IC, TCC, Pós, Extensão, Monitoria): tarefas, cronograma, reuniões, diário de bordo, equipe, orientandos, CRediT, orçamento com OCR de notas fiscais, ética/compliance/riscos, copiloto e brainstorm de IA, integração ORCID e páginas públicas de projeto.", category: "feature", status: "released", priority: "high", released_at: "2025-11-01", module: "pesquisa", version: null },
  { title: "Rede de Coautoria", description: "Grafo interativo de colaborações entre autores construído a partir dos artigos das buscas salvas, com clique para ver papers compartilhados.", category: "feature", status: "released", priority: "medium", released_at: "2025-11-01", module: "busca", version: null },
  { title: "Agente automático de changelog e Oráculo sempre atualizado", description: "A cada atualização do sistema, uma IA registra automaticamente uma entrada no changelog com data e hora, e o assistente Oráculo passa a considerar essas atualizações em tempo real nas suas respostas.", category: "improvement", status: "released", priority: "medium", released_at: "2025-11-01", module: "sistema", version: null },
];
