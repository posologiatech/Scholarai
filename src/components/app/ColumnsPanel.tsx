        ...
        {activeTab === "columns" ? (
          ...
          <div className="flex flex-1 flex-col overflow-hidden">
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              {(synthesis || synthLoading) && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    {synthesis && !synthLoading && (
                      <button onClick={handleCopySynthesis} className="text-muted-foreground hover:text-foreground transition-colors">
                        {synthCopied ? <Check className="h-3.5 w-3.5 text-emerald-500" /> : <Copy className="h-3.5 w-3.5" />}
                      </button>
                    )}
                  </div>
                  {synthLoading && !synthesis && (
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      {locale === "pt" ? "Sintetizando papers..." : "Synthesizing papers..."}
                    </div>
                  )}
                  {synthesis && (
              ...
              {/* Chat messages */}
              {chatMessages.length === 0 && !synthesis && !synthLoading && (
