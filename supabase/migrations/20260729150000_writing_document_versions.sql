...
CREATE INDEX IF NOT EXISTS idx_writing_document_versions_document ON public.writing_document_versions(document_id, created_at DESC);
...
DROP POLICY IF EXISTS "Owners read versions" ON public.writing_document_versions;
...
DROP POLICY IF EXISTS "Owners insert versions" ON public.writing_document_versions;
...
DROP POLICY IF EXISTS "Owners delete versions" ON public.writing_document_versions;
